...
class BUTTONS(object):
    ...
    [InlineKeyboardButton(" ᴛᴀɢ-ᴀʟʟ 🏷️", callback_data="mplus HELP_TagAll"),
    ...
    InlineKeyboardButton(" ᴀᴄᴛɪᴏɴ 🕸️", callback_data="mplus HELP_Action"),InlineKeyboardButton(" sᴇᴀʀᴄʜ 🔎", callback_data="mplus HELP_Search")],    
    ...
    InlineKeyboardButton("𝗦𝗛𝗔𝗚𝗨𝗡 ғᴜɴ 🎐", callback_data="mplus HELP_Fun"),InlineKeyboardButton(" ǫᴜᴏᴛʟʏ 🩹", callback_data="mplus HELP_Q")],          
